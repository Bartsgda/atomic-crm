...
export const AdvancedFilters: React.FC<Props> = ({ isOpen, filters, onFilterChange, onClose, onClear }) => {
  ...
  return (
    <div className="mb-6 bg-white dark:bg-zinc-900 border-2 border-zinc-100 dark:border-zinc-800 rounded-[2rem] p-6 shadow-2xl animate-in slide-in-from-top-2 duration-300 relative overflow-hidden">
