        ...
        <div className="flex-1 overflow-hidden relative">
            ...
            {isQuickAddOpen && (
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-zinc-900/20 backdrop-blur-sm" onClick={() => setIsQuickAddOpen(false)}>
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2rem] shadow-2xl w-96 border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
