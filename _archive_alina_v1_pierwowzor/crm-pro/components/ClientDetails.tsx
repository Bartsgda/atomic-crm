...
export const ClientDetails: React.FC<Props> = ({ client, policies, notes, terminations, onNavigate, onDeletePolicy, onUpdatePolicy, onAddNote, onUpdateNote, onDeleteNote, onUpdateClient, onRefresh, resumeNoteId, highlightPolicyId, autoOpenPolicyId }) => {
