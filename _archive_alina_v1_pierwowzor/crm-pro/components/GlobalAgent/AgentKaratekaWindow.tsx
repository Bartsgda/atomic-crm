    ...
    if (!isOpen) {
        return (
            <button 
                ...
                className="fixed bottom-6 right-6 z-[9999] p-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-full shadow-2xl border-4 border-white dark:border-zinc-800 font-black hover:scale-110 transition-transform flex items-center justify-center group animate-in zoom-in"
                title="Terminal Agenta"
            >
                <Terminal size={24} />
            </button>
        );
