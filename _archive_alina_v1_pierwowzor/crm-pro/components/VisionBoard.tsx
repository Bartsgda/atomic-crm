...
export const VisionBoard: React.FC = () => {
    ...
    return (
        <div className="p-6 md:p-10 max-w-5xl mx-auto h-full flex flex-col">
            ...
            {/* Content */}
            <div className="flex-1 bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden flex flex-col relative">
