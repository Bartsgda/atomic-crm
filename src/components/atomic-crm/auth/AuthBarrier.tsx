...
export const AuthBarrier: React.FC<AuthBarrierProps> = ({ children }) => {
  ...
  const resetTimer = useCallback(() => {
    ...
    timerRef.current = setTimeout(() => {
      console.warn("[Security] Inactivity limit reached. Auto-logout.");
      handleLogout();
    }, SESSION_TIMEOUT_MS);
    ...
    <>
      ...
      {showWarning && (
        <div className="fixed inset-0 z-[100000] bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-[#111318] border border-white/10 rounded-2xl p-8 max-w-md w-full shadow-2xl flex flex-col items-center text-center">
      ...
      {/* User widget moved to StatusEye (prawy dolny róg) */}
