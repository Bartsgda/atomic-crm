-- Migration: sync_prod_to_test v3 — dynamiczne kolumny + sprawdzanie updated_at
-- Dla każdej tabeli sprawdza czy updated_at istnieje w OBU schematach.
-- Nie zakłada nic na sztywno.
...
DECLARE
  ...
  -- Wszystkie tabele do syncowania (poza policy_sub_agent_shares)
...
BEGIN
  ...
  FOREACH t IN ARRAY all_tables LOOP
    ...
    IF v_has_ts THEN
      ...
      -- UPDATE gdy prod jest nowszy niż test
      EXECUTE format(
